...
class ucp_controller
{
	...
	public function display_options()
	{
		...
		add_form_key('evilsystem_requests_ucp');
		...
		$data = array(
			'user_requests' => $this->request->variable('user_requests', $this->user->data['user_requests']),
		);
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			if (!check_form_key('evilsystem_requests_ucp'))
			{
			...
			if (empty($errors))
			{
				...
				$message = $this->language->lang('UCP_REQUESTS_SAVED') . '<br /><br />' . $this->language->lang('RETURN_UCP', '<a href="' . $this->u_action . '">', '</a>');
		...
		$this->template->assign_vars(array(
			...
			'S_USER_REQUESTS'	=> $data['user_requests'],
		));
	}
